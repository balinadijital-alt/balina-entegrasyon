...
export const api = {
  ...
  settings: {
    ...
    webhookDeliveries: (params) => http.get('/settings/webhook-deliveries', { params }).then((response) => response.data),
  },
  modules: {
  ...
  marketplaces: {
    ...
    trendyolCargoProviders: (id, params) => http.get(`/marketplaces/${id}/trendyol/cargo-providers`, { params }).then((response) => response.data),
    ...
    trendyolUpdateBoxInfo: (id, orderId, payload) => http.post(`/marketplaces/${id}/trendyol/orders/${orderId}/box-info`, payload).then((response) => response.data),
    trendyolChangeCargoProvider: (id, orderId, payload) => http.post(`/marketplaces/${id}/trendyol/orders/${orderId}/cargo-provider`, payload).then((response) => response.data),
    trendyolDeliveredByService: (id, orderId, payload) => http.post(`/marketplaces/${id}/trendyol/orders/${orderId}/delivered-by-service`, payload).then((response) => response.data),
    trendyolReturns: (id, params) => http.get(`/marketplaces/${id}/trendyol/returns`, { params }).then((response) => response.data),
    trendyolReturnClaims: (id) => http.get(`/marketplaces/${id}/trendyol/returns/claims`).then((response) => response.data),
    trendyolSyncReturnClaims: (id, params) => http.post(`/marketplaces/${id}/trendyol/returns/claims/sync`, null, { params }).then((response) => response.data),
    trendyolReturnIssueReasons: (id, params) => http.get(`/marketplaces/${id}/trendyol/returns/issue-reasons`, { params }).then((response) => response.data),
    trendyolCreateReturnIssue: (id, claimId, payload) => http.post(`/marketplaces/${id}/trendyol/returns/${claimId}/issue`, payload).then((response) => response.data),
    trendyolApproveReturnClaim: (id, claimId, payload) => http.post(`/marketplaces/${id}/trendyol/returns/${claimId}/approve`, payload).then((response) => response.data),
    trendyolReturnClaimAudits: (id, claimId, params) => http.get(`/marketplaces/${id}/trendyol/returns/${claimId}/audits`, { params }).then((response) => response.data),
    ...
    trendyolDeleteInvoiceLink: (id, packageId) => http.delete(`/marketplaces/${id}/trendyol/shipment-packages/${packageId}/invoice-link`).then((response) => response.data),
    trendyolSendInvoiceFile: (id, packageId, payload) => http.post(`/marketplaces/${id}/trendyol/shipment-packages/${packageId}/invoice-file`, payload).then((response) => response.data),
    trendyolSendOrderInvoiceLink: (id, orderId, payload) => http.post(`/marketplaces/${id}/trendyol/orders/${orderId}/invoice-link`, payload).then((response) => response.data),
    trendyolDeleteOrderInvoiceLink: (id, orderId) => http.delete(`/marketplaces/${id}/trendyol/orders/${orderId}/invoice-link`).then((response) => response.data),
    trendyolSendOrderInvoiceFile: (id, orderId, payload) => http.post(`/marketplaces/${id}/trendyol/orders/${orderId}/invoice-file`, payload).then((response) => response.data),
