...
export const appNavigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/marketplace-mapping/categories', label: 'Kategori Eslestirme', icon: Tags, permissions: ['marketplaces.manage'] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/marketplace-readiness', label: 'Pazaryeri Hazirlik', icon: SearchCheck, permissions: ['marketplaces.manage'] },
      { to: '/marketplace-mapping/categories', label: 'Kategori Eslestirme', icon: Layers3, permissions: ['marketplaces.manage'] },
