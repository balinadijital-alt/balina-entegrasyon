...
export const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/products/category-mapping', label: 'Kategori Esleme', icon: Tags },
      { to: '/products/publish-queue', label: 'Aktarim Listesi', icon: ClipboardCheck },
      { to: '/products/publish', label: 'Pazaryerine Gonder', icon: Send },
      { to: '/catalog/variants', label: 'Varyantlar', icon: Tags },
      { to: '/pricing/profit-rules', label: 'Fiyat Motoru', icon: Percent },
      { to: '/imports', label: 'Excel XML Import', icon: UploadCloud },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/products/publish-queue', label: 'Batch Sonuclari', icon: ClipboardCheck },
